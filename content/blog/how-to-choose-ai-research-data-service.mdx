...
**Increasing journal requirements.** The AEA, QJE, Econometrica, and most major journals now mandate replication packages with documented data provenance. This has raised the minimum quality standard for data processing and made sloppy data work a publication liability.
