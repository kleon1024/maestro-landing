...
Journals increasingly require replication packages that document every data transformation. Building these packages retroactively -- reconstructing the logic of cleaning decisions made months earlier -- is one of the most tedious and error-prone tasks in academic research.
