...
// Design: Institutional light theme (slate-50 bg, navy/gold palette)
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {SERVICES.map((service) => (
            <div
              key={service.id}
              className="bg-white border border-slate-200 p-8 hover:border-blue-300 hover:shadow-md transition-all duration-300"
            >
              {/* Top row: number + icon */}
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="w-10 h-10 flex items-center justify-center bg-blue-50 text-blue-700">
        ...
        <div className="mt-12 bg-[#FFFBEB] border border-[#FCD34D] p-8 md:p-10">
          <div className="flex items-center gap-2 mb-4">
            <span className="w-2 h-2 rounded-full bg-amber-400" />
            <span className="text-xs font-semibold tracking-wider text-[#B8860B] uppercase">
              SG Budget 2026
            </span>
          </div>
